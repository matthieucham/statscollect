    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field",
                    models.CharField(choices=[("FOOTBALL", "Football")], max_length=10),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "migration_id",
                    models.CharField(unique=True, null=True, max_length=35),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "original_rating",
                    models.DecimalField(null=True, decimal_places=2, max_digits=5),
                ),
            ],
            options={
                "verbose_name": "note",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(serialize=False, max_length=8, primary_key=True),
                ),
                ...
                (
                    "field",
                    models.CharField(
                        blank=True, choices=[("FOOTBALL", "Football")], max_length=10
                    ),
                ),
                (
                    "country",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field",
                    models.CharField(
                        choices=[("FOOTBALL", "Football"), ("CYCLING", "Cycling")],
                        max_length=10,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("NAT", "National"), ("INT", "International")],
                        max_length=3,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("ONGOING", "Ongoing"), ("ARCHIVED", "Archived")],
                        max_length=8,
                        default="ARCHIVED",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="statscollect_db.TournamentInstance",
                        related_name="steps",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="statscollect_db.Person"
            ),
        ),
        migrations.AddField(
            model_name="teammeetingperson",
            name="played_for",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="statscollect_db.Team"
            ),
        ),
        migrations.AddField(
            model_name="team",
            ...
            field=models.ManyToManyField(
                related_name="current_teams", blank=True, to="statscollect_db.Person"
            ),
        ),
        migrations.AddField(
            model_name="rating",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="statscollect_db.RatingSource",
            ),
        ),
        migrations.AddField(
            model_name="meeting",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="meetings",
                null=True,
                to="statscollect_db.TournamentInstanceStep",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="statscollect_db.TeamMeeting",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="statscollect_db.Team",
                related_name="meetings_away",
            ),
        ),
        migrations.AddField(
            model_name="teammeeting",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="statscollect_db.TeamMeetingPerson",
                to="statscollect_db.Person",
            ),
        ),
        migrations.AddField(
